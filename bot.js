...
const actions = {
  ...
  ['getCurrent'](sessionId, context, cb) {
    request({
      url: `http://api.openweathermap.org/data/2.5/weather?q=${context.loc}&units=metric&type=accurate&APPID=07976ea0d7f1371a9e527add86391b84`,
      json: true
...
Égkép               ${response.body.main.weather.description}
