...
if ( ${response.body.wind.deg} > 338 and  ${response.body.wind.deg}  < 23) { irany = "A szél iránya Északi"; }
if ( ${response.body.wind.deg} > 22  and  ${response.body.wind.deg}  < 67) { irany = "A szél iránya Északkeleti";}
if ( ${response.body.wind.deg} > 67  and  ${response.body.wind.deg}  < 102) {irany = "A szél iránya Keleti";}
if ( ${response.body.wind.deg} > 102 and  ${response.body.wind.deg}  < 147) { irany = "A szél iránya Délkeleti";}
if ( ${response.body.wind.deg} > 147 and  ${response.body.wind.deg}  < 193) { irany = "A szél iránya Déli";}
if ( ${response.body.wind.deg} > 193 and  ${response.body.wind.deg}  < 238) { irany = "A szél iránya Délnyugati";}
if  (${response.body.wind.deg} > 238 and  ${response.body.wind.deg}  < 283) { irany = "A szél iránya Nyugati";}
if  (${response.body.wind.deg} > 283 and  ${response.body.wind.deg}  < 339) { irany = "A szél iránya Északnyugati";}
